...
const content = {
    ar: {
        ...
        p3Desc: "بأول صورة من منتجاتي تتشر علي الانترنت  وما يثير في نفسي الشجن والحنين ان الصورة من مسقط رأسي باسوان الحبيبة.",
        p3Status: "حلمي قريباً ⏳", p3Link: "رابط مؤقت للمتابعة", riddleTitle: "لغز الأسبوع", riddleBtn: "إرسال الإجابة",
        blogTitle: "مدونة هلوسات", post1Title: "أولى الهلوسات: الكلمة",
        post1Excerpt: "هنا افضفض اخرف او ربما اهلوس...", post1Link: "اقرأ المزيد ←",
